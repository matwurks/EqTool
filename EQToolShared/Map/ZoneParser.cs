    ...
    public static class ZoneParser
    {
        ...
        static ZoneParser()
        {
            ...
            ZoneInfoMap.Add("befallen", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Boondin Babbinsbort", "Commander Windstream", "An Elf Skeleton", "Gynok Moltor", "Priest Amiaz",
                    "Skeleton Lrodd", "The Thaumaturgist"
                },
            ...
            ZoneInfoMap.Add("beholder", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "King Xorbb", "Lord Syrkl", "Lord Sviir", "Lord Soptyvr", "SpinFlint", "Brahhm",
                    "Yymp the Infernal", "Qlei", "Goblin Alchect"
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ...
            ZoneInfoMap.Add("charasis", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Sentient Bile", "The Crypt Excavator", "The Crypt Feaster", "The Crypt Keeper", "Drusella Sathir",
                    "Embalming Fluid", "The Golem Master", "Reanimated Plaguebone", "Skeletal Procurator",
                    "The Skeleton Sepulcher", "The Spectre Spiritualist", "The Undertaker Lord",
                },
            ...
            ZoneInfoMap.Add("citymist", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "a black reaver", "an army behemoth", "Captain of the Guard", "a human skeleton", "Lhranc",
                    "Lord Ghiosk", "Lord Rak`Ashiir", "Neh`Ashiir", "spectral courier", "Wraith of Jaxion",
                },
                RespawnTime = new TimeSpan(0, 22, 00),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("crushbone", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Orc Taskmaster", "Orc Trainer", "Orc Warlord", "Ambassador DVinn", "Lord Darish", "Rondo Dunfire",
                    "Retlon Brenclog", "Emperor Crush", "The Prophet",
                },
            ...
            ZoneInfoMap.Add("dalnir", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Coerced Channeler", "Coerced Crusader", "Coerced Penkeeper", "a coerced revenant",
                    "a coerced smith", "Kly Imprecator", "The Kly Overseer", "The Kly", "Spectral Crusader",
                    "an undead blacksmith", "lumpy goo",
                },
            ...
            ZoneInfoMap.Add("dreadlands", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Gorenaire", "A dread widow", "a mountain giant patriarch", "a wulfare lonewolf",
                    "wraithbone champion",
                },
                RespawnTime = new TimeSpan(0, 6, 40),
                NpcSpawnTimes = new List<NpcSpawnTime>()
            ...
            ZoneInfoMap.Add("droga", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "a goblin bodyguard", "Chief Rokgus", "a goblin canyoneer", "a maddened Burynai",
                    "Soothsayer Dregzak", "An angry goblin", "Warlord Skargus"
                },
                RespawnTime = new TimeSpan(0, 20, 30)
            });
            ...
            ZoneInfoMap.Add("eastwastes", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Boridain Glacierbane", "Gloradin Coldheart", "Chief Ry`Gorr", "Corbin Blackwell",
                    "Ekelng Thunderstone", "Firbrand the Black", "Oracle of Ry'Gorr", "Fjloaren Icebane",
                    "Garadain Glacierbane", "Ghrek Squatnot", "Tain Hammerfrost", "Warden Bruke"
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ...
            ZoneInfoMap.Add("everfrost", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Karg IceBear", "Lich of Miragul", "Megan", "Tundra Jack", "Iceberg", "Snowflake", "Sulon McMoor",
                    "Redwind", "Martar IceBear", "Dark Assassin", "Corrupted wooly",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ...
            ZoneInfoMap.Add("feerrott", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Annaelia Wylassi", "Aqaar Aluram", "Cyndreela", "Dark Assassin", "Eleann Morkul",
                    "Oknoggin Stonesmacker", "Roror", "Spanner Scrapsnatcher",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ...
            ZoneInfoMap.Add("fieldofbone", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "A scaled prowler", "A skeletal jester", "Burynaibane Spider", "Carrion Queen", "Gharg Oberbord",
                    "Iksar Dakoit", "Jairnel Marfury", "Kerosh Blackhand", "Targishin", "The Tangrin",
                    "a burynai cutter", "a scourgetail scorpion",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ...
            ZoneInfoMap.Add("frozenshadow", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Large Undead Gnoll", "Xalgoti", "Zorglim the Dead", "Enraged Shadowbeast", "Amontehepna",
                    "Narmak Berreka", "maggot infested flesh", "Eugie", "Isopca", "Lerty", "Nosja", "Otdd", "Pelpa",
                    "Priest Majes Medory", "Tihgren", "Varjie", "Vyakna", "enraged relative", "lucid spirit of Abrams",
                    "Vhal'Sera",
                },
                RespawnTime = new TimeSpan(0, 20, 0)
            });
            ...
            ZoneInfoMap.Add("greatdivide", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Sentry Badain", "Bekerak Coldbones", "Blizzent", "Bloodmaw", "Captain Stonefist",
                    "Drakkel Blood Wolf", "Fergul Frostsky", "Gralk Dwarfkiller", "Icetooth", "Korf Brokenhammer",
                    "Relik", "Shardtooth", "Shardwurm Broodmother", "Shardwurm Matriarch", "a Tizmak Spiritcaller",
                    "Vluudeen", "Vores the Hunter", "Yaka Razorhoof"
                },
            ...
            ZoneInfoMap.Add("growthplane", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Ancient Totem", "Ail the Elder", "Fayl Everstrong", "Farstride Unicorn", "Prince Thirneg",
                    "Galiel Spirithoof", "Grahl Strongback", "A Phase Puma", "Ordro", "Sarik the Fang",
                    "Treah Greenroot", "Undogo Digolo", "Tunare"
                },
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
                    new NpcSpawnTime
            ...
            ZoneInfoMap.Add("gukbottom", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "a basalt gargoyle", "Raster of Guk", "a frenzied ghoul", "a froglok crusader",
                    "a froglok herbalist", "the froglok king", "a froglok noble", "a yun priest", "a froglok tactician",
                    "the ghoul arch magus", "a ghoul assassin", "a ghoul cavalier", "a ghoul executioner",
                    "the ghoul lord", "a ghoul ritualist", "a ghoul sage", "a ghoul savant", "a ghoul scribe",
                    "a ghoul sentinel", "a ghoul supplier", "a huge water elemental", "a minotaur elder",
                    "a minotaur patriarch", "a reanimated hand", "Slaythe the Slayer"
                },
            ...
            ZoneInfoMap.Add("guktop", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "a froglok gaz squire", "a froglok idealist", "a froglok realist", "a froglok necromancer",
                    "a froglok scryer", "a froglok summoner", "a froglok nokta shaman", "a froglok shin knight",
                    "the froglok shin lord", "Tempus", "a giant heart spider",
                },
            ...
            ZoneInfoMap.Add("hateplane", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    ...
                    "Mistress of Scorn", "Maestro of Rancor", "Innoruuk"
                },
                RespawnTime = new TimeSpan(8, 0, 0)
            });
            ...
            ZoneInfoMap.Add("highpass", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Cyrla Shadowstepper", "Dyllin Starsine", "Hagnis Shralok", "Recfek Shralok", "Vopuk Shralok",
                    "Vexven Mucktail", "Grenix Mucktail", "Barn Bloodstone",
                },
            ...
            ZoneInfoMap.Add("hole", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Bejeweled Elemental", "Commander Yarik", "Caradon", "Dartain the Lost", "Ghost of Kindle",
                    "Ghost of Glohnor", "Gibartik", "High Scale Kirn", "Initiate Sirlis", "Irslak the Wretched",
                    "Jaeil the Wretched", "Keeper of the Tombs", "Kejar the Mighty", "Master Yael",
                    "Niltoth the Unholy", "Nortlav the Scalekeeper", "Polzin Mrid", "a ratman guard", "Rocksoul",
                    "Schnozz the Flighty", "Stonegrinder Minion", "Stonesoul the Unmoving", "Ulrik the Devout",
                },
            ...
            ZoneInfoMap.Add("innothule", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Bunk Oden", "Jojoojojgogogoguna", "Jyle Windstorm", "Jojongua", "Zimbittle", "a troll slayer",
                    "Spore Guardian", "Lynuga",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("kael", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "The Avatar of War", "The Statue of Rallos Zek", "Derakor the Vindicator", "King Tormax",
                    "Bjrakor the Cold", "Captain Bvellos", "Gkrean Prophet of Tallon", "Semkak Prophet of Vallon",
                    "Gorul Longshanks", "Keldor Dek`Torek", "Noble Helssen", "Slaggak the Trainer",
                    "Staff Sergeant Drioc", "Vkjor", "Wenglawks Kkeak",
                },
                RespawnTime = new TimeSpan(0, 28, 0),
                NpcSpawnTimes = new List<NpcSpawnTime>
                {
            ...
            ZoneInfoMap.Add("kaesora", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Hungered Ravener", "failed crypt raider", "Frenzied Strathbone", "Reaver of Xalgoz",
                    "spectral guardian", "spectral librarian", "Strathbone Runelord", "tortured librarian",
                    "Warder of Xalgoz",
                },
                RespawnTime = new TimeSpan(0, 18, 0)
            });
            ...
            ZoneInfoMap.Add("karnor", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Caller of Sathir", "A construct", "Construct of Sathir", "a cursed hand", "a drolvarg captain",
                    "A Drolvarg Pawbuster", "a Drolvarg warlord", "Hangnail", "a human skeleton", "Knight of Sathir",
                    "Sentry of Sathir", "Skeletal Berserker", "Skeletal Captain", "Skeletal Caretaker",
                    "Skeletal Scryer", "skeletal warlord", "Spectral Turnkey", "Undead Jailor", "Venril Sathir",
                    "Venril Sathir Remains", "Verix Kyloxs Remains"
                },
            ...
            ZoneInfoMap.Add("kedge", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Phinigel Autropos", "Cauldronboil", "Cauldronbubble", "Coralyn Kelpmaiden",
                    "Estrella of Gloomwater", "Fierce Impaler", "a ferocious cauldron shark", "Frenzied Cauldron Shark",
                    "Golden Haired Mermaid", "Stiletto Fang Piranha", "Seahorse Patriarch", "Seahorse Matriarch",
                    "Shellara Ebbhunter", "Undertow", "Swirlspine",
                },
                RespawnTime = new TimeSpan(0, 22, 0)
            });
            ...
            ZoneInfoMap.Add("kithicor", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Ged Twigborn", "Mildin Whistler", "Chief Gan`Shralok", "Recfek Shralok",
                    "and the other Shralok Orcs", "Thumper", "Irin Lunis", "Leaf Falldim", "Kithicor", "Eenot", "Kobb",
                    "Giz X`Tin"
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("kurn", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Bargynn", "Burynai Forager", "fingered skeleton", "an odd mole", "a skeletal cook",
                    "thick boned skeleton", "undead crusader", "an undead jester",
                },
            ...
            ZoneInfoMap.Add("lavastorm", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Deep Lava Basilisk", "Eejag", "Hykallen", "A lesser nightmare", "Sir Lindeal", "a warbone monk",
                    "a warbone spearman",
                },
                RespawnTime = new TimeSpan(0, 6, 40),
                NpcSpawnTimes = new List<NpcSpawnTime>()
            ...
            ZoneInfoMap.Add("mistmoore", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "an advisor", "an avenging caitiff", "Black Dire", "Butler Syncall", "a cloaked dhampyre",
                    "a deathly usher", "Enynti", "Garton Viswin", "a glyphed ghoul", "an imp familiar", "Lasna Cheroon",
                    "Maid Issis", "Mayong Mistmoore", "Mynthi Davissi", "Princess Cherista", "Ssynthi", "Xicotl",
                },
                RespawnTime = new TimeSpan(0, 22, 00),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("najena", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Akksstaff", "BoneCracker", "Drelzna", "Ekeros", "Linara Parlone", "Moosh", "Najena",
                    "Officer Grush", "Rathyl", "Rathyl reincarnate", "Trazdon", "a visiting priestess",
                    "The Widowmistress",
                },
                RespawnTime = new TimeSpan(0, 19, 0)
            });
            ZoneInfoMap.Add("necropolis", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Zlandicar", "A Paebala Spirit Talker", "Dominator Yisaki", "Garzicor's Wraith",
                    "Jaled Dar`s Shade", "Neb", "Queen Raltaas", "Seeker Bulava", "Vaniki", "Vilefang",
                    "Warmaster Utvara"
                },
            ...
            ZoneInfoMap.Add("northkarana", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Xanuusus", "Ashenpaw", "Zahal the Vile", "GrimFeather", "Swiftclaw", "Lieutenant Midraim",
                    "The Silver Griffon", "Timbur the Tiny", "Korvik the Cursed",
                },
                RespawnTime = new TimeSpan(0, 6, 0)
            });
            ...
            ZoneInfoMap.Add("oot", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Capt Surestout", "Nerbilik", "Oracle of K`Arnon", "Boog Mudtoe", "Gornit", "Sentry Xyrin",
                    "Gull Skytalon", "Allizewsaur", "Ancient Cyclops", "Brawn", "Quag Maelstrom",
                    "Seplawishinl Bladeblight", "Soarin Brightfeather", "tainted seafury cyclops",
                    "corrupted seafury cyclops", "Wiltin Windwalker", "A Goblin",
                },
                RespawnTime = new TimeSpan(0, 6, 0),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("overthere", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Admiral Tylix", "Captain Rottgrime", "General V`Deers", "Impaler Tzilug", "Tourmaline",
                    "Corundium", "Stishovite", "Tektite", "A Cliff Golem",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ...
            ZoneInfoMap.Add("paw", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Brother Hayle", "The Ishva Mal", "Kurrpok Splitpaw", "Tesch Val Kadvem", "Tesch Val Deval`Nmak",
                    "Nisch Val Torash Mashk", "Rosch Val L'Vlor"
                },
                RespawnTime = new TimeSpan(0, 22, 0),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("permafrost", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Lady Vox", "Priest of Nagafen", "High Priest Zaharn", "A goblin alchemist (Permafrost)",
                    "King Thex'Ka IV", "Goblin Archeologist", "Goblin Patriarch", "Goblin Preacher",
                    "Goblin Jail Master", "Goblin Scryer", "Elite Honor Guard", "Injured Polar Bear",
                    "Ice Goblin Champion", "Ice Giant Diplomat",
                },
                RespawnTime = new TimeSpan(0, 22, 0)
            });
            ...
            ZoneInfoMap.Add("rathemtn", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Ankhefenmut", "Findlegrob", "Sindlegrob", "Bindlegrob", "Blackwing", "Broog Bloodbeard",
                    "Brother Zephyl", "Grazhak the Berserker", "Hasten Bootstrutter", "Maldyn the Unkempt",
                    "monstrous zombie", "Mortificator Syythrak", "Oculys Ogrefiend", "Petrifin", "Quid Rilstone",
            ...
            ZoneInfoMap.Add("runnyeye", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Borxx", "an Evil Eye prisoner", "Sludge Dankmire", "A Goblin Captain", "Goblin Warlord",
                    "The Goblin King", "Slime Elemental", "Gelatinous Cube",
                },
                RespawnTime = new TimeSpan(0, 22, 0)
            });
            ZoneInfoMap.Add("sebilis", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Arch Duke Iatol", "Baron Yosig", "blood of chottal", "Brogg", "crypt caretaker", "Emperor Chottal",
                    "frenzied pox scarab", "Froggy", "froglok armorer", "froglok armsman", "froglok chef",
                    "froglok commander", "froglok ostiary", "froglok pickler", "froglok repairer", "Gangrenous scarab",
                    "Gruplinort", "Harbinger Freglor", "Hierophant Prime Grekal", "myconid spore king",
                    "a necrosis scarab", "sebilite protector", "Tolapumj", "Trakanon",
                },
                RespawnTime = new TimeSpan(0, 27, 0),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("sirens", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Elna Kelpweaver", "Fellspine", "Helsia Mindreaver", "Mistress Latazura", "Priestess Sercema",
                    "Shimmering Sea Spirit", "Ulth the Enraged"
                },
                RespawnTime = new TimeSpan(0, 28, 0)
            });
            ZoneInfoMap.Add("skyfire", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Black Scar", "Eldrig the Old", "Faerie of Dismay", "Felia Goldenwing", "Guardian of Felia",
                    "Jennus Lyklobar", "a lava walker", "a shadow drake", "a soul devourer", "Talendor",
                    "a wandering wurm", "a wurm spirit",
                },
                RespawnTime = new TimeSpan(0, 13, 0)
            });
            ...
            ZoneInfoMap.Add("sleeper", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Kerafyrm", "The Progenitor", "The Final Arbiter", "Master of the Guard", "Hraashna the Warder",
                    "Nanzata the Warder", "Tukaarak the Warder", "Ventani the Warder"
                },
                RespawnTime = new TimeSpan(8, 0, 0)
            });
            ZoneInfoMap.Add("soldunga", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Captain Bipnubble", "CWG Model EXG", "Fire Goblin Bartender", "Inferno Goblin Captain",
                    "Fire Goblin Drunkard", "Goblin High Shaman", "Solusek Goblin King", "Gabbie Mardoddle",
                    "flame goblin foreman", "Inferno Goblin Torturer", "Kindle", "Kobold predator", "lava elemental",
                    "Lord Gimblox", "Lynada the Exiled", "Marfen Binkdirple", "Reckless Efreeti", "Singe",
                },
                RespawnTime = new TimeSpan(0, 18, 0)
            });
            ZoneInfoMap.Add("soldungb", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "death beetle", "Efreeti Lord Djarn", "guano harvester", "King Tranix", "kobold champion",
                    "kobold noble", "kobold priest", "Lord Nagafen", "Midghh the Dark", "Magi Rokyl", "noxious spider",
                    "Solusek kobold king", "stone spider", "Targin the Rock", "Warlord Skarlon", "Zordak Ragefire"
                },
                RespawnTime = new TimeSpan(0, 22, 0)
            });
            ...
            ZoneInfoMap.Add("southkarana", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Baenar Swiftsong", "Brother Drash", "Brother Qwinn", "Coloth Meadowgreen", "Cracktusk",
                    "Ghanex Drah", "Gnashmaw", "Gnawfang", "Grizzleknot", "Groi Gutblade", "Knari Morawk",
                    "Krak Windchaser", "Kroldir Thunderhoof", "Lord Grimrot", "Marik Clubthorn", "Mroon",
                    "Narra Tanith", "Quillmane", "Sentry Alechin", "Synger Foxfyre", "Undead Cyclops", "Vhalen Nostrolo"
                },
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
                    new NpcSpawnTime
            ...
            ZoneInfoMap.Add("sro", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Ancient Cyclops", "Erg Bluntbruiser", "Ortallius", "Rathmana Allin", "Sandgiant Husam", "Scrounge",
                    "Terrorantula", "Young Ronin",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("steamfont", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Feddi Dooger", "A Kobold Missionary", "Meldrath The Malignant", "Minotaur Hero", "Minotaur Lord",
                    "Renux Herkanor", "Nilit's contraption",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("stonebrunt", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Arglar the Tormentor", "Ghost of Ridossan", "Giang Yin", "a heretic invader",
                    "Hurglak the Destroyer", "Mirabai", "Miranda", "Khonza Ayssla", "Mrowro Wirewhisker",
                    "Old Ghostback", "Prowler of the Jungle", "Rognarog the Infuriated", "Saemey Wirewhisker",
                    "Slyder the Ancient", "Snowbeast"
                },
            ...
            ZoneInfoMap.Add("swampofnohope", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Bloodgorge", "an escaped froglok", "Deadeye", "Dreesix Ghoultongue", "Dugroz",
                    "Fakraa the Forsaken", "Fangor", "Frayk", "Froglok Repairer", "Froszik the Impaler",
                    "Grik the Exiled", "Grimewurm", "Grizshnok", "Soblohg", "Two Tails", "Ulump Pujluk", "Venomwing",
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("templeveeshan", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Casalen", "Dozekar the Cursed", "Essedera", "Grozzmel", "Krigara", "Lepethida", "Midayor",
                    "Tavekalem", "Ymmeln", "Gozzrem", "Lendiniara the Keeper", "Telkorenar", "Cekenar",
                    "Dagarn the Destroyer", "Eashen of the Sky", "Ikatiar the Venom", "Jorlleag", "Lady Mirenilla",
                    "Lady Nevederia", "Lord Feshlak", "Lord Koi'Doken", "Lord Kreizenn", "Lord Vyemm", "Sevalak",
                    "Vulak`Aerr", "Zlexak",
                },
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("timorous", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Faydedar", "The Great Oowomp", "Halara", "an Iksar master", "Ugrak da Raider", "Xiblin Fizzlebik",
                    "Alrik Farsight"
                },
                RespawnTime = new TimeSpan(0, 12, 0)
            });
            ...
            ZoneInfoMap.Add("trakanon", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Bloodeye", "Champion Arlek", "Champion Thenrin", "Commander Sils", "Crusader Zoglic", "Doom",
                    "Dragontail", "Dreadlord Fanrik", "Ebon Lotus", "Emperor Ganak", "Fallen Iksar", "Ffroaak",
                    "froglok forager", "froglok hunter", "Hangman", "Harbinger Dronik", "Harbinger Josk",
                    "A human skeleton", "Klok Denris", "Knight Dragol", "Pained Soul", "Sigra", "Silvermane",
                    "Squire Glik", "Stonebeak", "Throkkok", "Thruke", "Titail Sinok", "Trakanasaurus Rex", "Vessel Fryn"
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("unrest", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Garanel Rucksif", "a priest of najena", "Khrix Fritchoff", "Khrix's Abomination",
                    "Torklar Battlemaster", "Shadowpincer", "reclusive ghoul magus",
                },
                RespawnTime = new TimeSpan(0, 22, 0)
            });
            ...
            ZoneInfoMap.Add("velketor", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Lord Doljonijiarnimorinar", "Velketor the Sorcerer", "A Frenzied Velium Broodling",
                    "A Frenzied Velium Stalker", "Bled", "Bledrek", "Crystal Eyes", "Crystal Fang", "Errkak Icepaw",
                    "Failed Experiment", "Gregendek Icepaw", "Jelek Icepaw", "Kalik Icepaw", "Kerd", "Kerdelb",
                    "Khelkar Icepaw", "Laryk Icepaw", "Leljemor", "Marlek Icepaw", "Meljemor", "Rijoely",
                    "Rowwek Icepaw", "The Brood Master", "The Brood Mother", "Tijoely", "Tpos Icepaw", "Ular Icepaw",
                    "Velketor's Experiment", "Venar Icepaw"
                },
            ...
            ZoneInfoMap.Add("wakening", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Wuoshi", "A Storm Giant Foreman", "A storm giant surveyor", "Corrupted Faun", "Corrupted Panther",
                    "Countess Silveana", "Eysa Florawhisper", "Frostgiant Overseer", "Grand Vizier Poolakacha`tei",
                    "Korzak Stonehammer", "Lady Gelistial", "Lieutenant Krofer", "Lord Gossimerwind", "Lord Prismwing",
                    "Phenocryst", "Priest Bjek", "Priest Delar", "Priest Grenk", "Rolandal", "Shamus Aghllsews",
                    "a corrupted unicorn", "a storm giant architect"
                },
                RespawnTime = new TimeSpan(0, 6, 40),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("warrens", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Cave Bat Lord", "Foodmaster Rargnar", "Grodl Ripclaw", "High Shaman Drogik", "Huntmaster Furgrl",
                    "Jailer Mkrarrg", "King Gragnar", "a kobold fisherman", "Krode the Diviner", "Lorekeeper Roggik",
                    "The Mighty Bear Paw", "Muglwump", "Packmaster Dledsh", "Prince Bragnar", "Smithy Rrarrgin",
                    "Trainer Daxgrr", "Warlord Drrig", "Grodl Ripclaw"
                },
                RespawnTime = new TimeSpan(0, 6, 40),
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
            ...
            ZoneInfoMap.Add("warslikswood", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "A shady goblin", "Grachnist the Destroyer", "Pit Fighter Dob", "Ssolet Dnaas", "Iksar Knight",
                    "Iksar Bandit Lord"
                },
                RespawnTime = new TimeSpan(0, 6, 40)
            });
            ZoneInfoMap.Add("westwastes", new ZoneInfo
            {
                ...
                NotableNPCs = new List<string>()
                {
                    "Atpaev", "Ayillish", "Bratavar", "Bufa", "Cargalia", "Del Sapara", "Derasinal", "Draazak",
                    "Entariz", "Esorpa of the Ring", "Gafala", "Gangel", "Glati", "Harla Dar", "Hechaeva", "Honvar",
                    "Ionat", "Jen Sapara", "Kar Sapara", "Karkona", "Klandicar", "Linbrak", "Makala", "Mazi",
                    "Melalafen", "Myga", "Neordla", "Nintal", "Onava", "Pantrilla", "Quoza", "Sivar", "Sontalak",
                    "Uiliak", "Vitaela", "Von", "Vraptin", "Yal", "Yeldema", "Zil Sapara", "Icehackle", "Makil Rargon",
                    "Mraaka", "Scout Charisa", "Strong Horn", "Tantor", "The Dragon Sage", "Tranala", "Tsiraka",
                    "a Kromzek Captain"
                },
                NpcSpawnTimes = new List<NpcSpawnTime>()
                {
